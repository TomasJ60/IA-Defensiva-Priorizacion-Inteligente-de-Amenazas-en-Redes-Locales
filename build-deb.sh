...
PKG_DIR="$BUILD_DIR/opt/agente-ia-defensiva"
DEB_DIR="$BUILD_DIR/DEBIAN"
OUTPUT="agente-ia-defensiva_1.0.0_all.deb"
...
cp "$PROJECT_DIR/debian/agente-ia-defensiva-web.service" "$BUILD_DIR/etc/systemd/system/agente-ia-defensiva-web.service"
cp "$PROJECT_DIR/debian/agente-ia-defensiva-agent.service" "$BUILD_DIR/etc/systemd/system/agente-ia-defensiva-agent.service"
cp "$PROJECT_DIR/debian/agente-ia-defensiva-ia.service" "$BUILD_DIR/etc/systemd/system/agente-ia-defensiva-ia.service"
